    ...
    return (
        <div>
            ...
            >
                ...
                {/* get rid of div below to include contact form later */}
                    ...
                    <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                        <div class="mb-12 max-w-[570px] lg:mb-0">
                            ...
                            <p class="text-body-color mb-9 text-base leading-relaxed mt-2">
                                Casually scrolling or actively looking, we'll be
                                happy to take your call! Whether you're looking
                                for a business opportunity or want to learn more
                                about us, we have different modes of access, all
                                to the same source. See you at the address!
                            </p>
                            <div class="mb-8 flex w-full max-w-[370px]">
                                ...
                                <div class="w-full">
                                    ...
                                    <p class="text-body-color text-base">
                                        9000 Weston Rd #3, Woodbridge, ON L4L
                                        0L1
                                    </p>
                                </div>
                            </div>
