    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 h-screen">
            ...
            <div className="flex items-center justify-center lg:justify-end mx-10">
                <img
                    src="https://plus.unsplash.com/premium_photo-1661883982941-50af7720a6ff?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=774&q=80"
                    alt="Image"
